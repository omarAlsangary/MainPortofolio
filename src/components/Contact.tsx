        ...
        <div className="contact-grid">
          <div className="contact-info reveal reveal-delay-1">
            ...
            <div className="contact-items">
              ...
              <a href="tel:+201113399727" className="contact-item">
                <div className="contact-item-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="contact-item-text">
                  ...
                  <span className="contact-item-value">971583031464</span>
                </div>
              </a>
          ...
          <div className="contact-cta reveal reveal-delay-2">
            <div className="contact-cta-badge">
              ...
              Open to Software Engineering & Technology Consulting roles
            </div>
            <p>
